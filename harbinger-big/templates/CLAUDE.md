...
- **Next.js wiring**: `next.config.mjs`, `instrumentation.js`, catch-all route, middleware — thin re-exports from `harbinger/*`
...
- Anything that should be shared across all users via `npm update harbinger`
