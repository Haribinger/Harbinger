...
import { SettingsIcon, SunIcon, MoonIcon, BugIcon, LogOutIcon } from './icons';
      ...
      <SidebarMenuItem>
        <DropdownMenu>
          ...
          <DropdownMenuContent align="start" side="top" className="w-56">
            ...
            <DropdownMenuItem onClick={() => window.open('https://github.com/stephengpope/harbinger/issues', '_blank')}>
              <BugIcon size={14} />
