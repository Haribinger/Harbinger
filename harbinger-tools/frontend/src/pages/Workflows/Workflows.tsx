...
import type { WorkflowTemplateIconKey } from '../../core/workflows/templates'
...
// Templates imported from core/workflows/templates (single source of truth)
...
function CreateWorkflowModal({
  ...
  const handleTemplateSelect = (tpl: (typeof WORKFLOW_TEMPLATES)[number]) => {
