...
const server = http.createServer((req, res) => {
  ...
  if (url === "/api/v1/info") {
    return json(res, 200, {
      name: "HexStrike AI",
      description: "MCP server providing 55+ integrated offensive security tools for the Harbinger agent swarm.",
      version: "1.0.0",
      tools_count: TOOLS.length,
  ...
  // Tool inventory — full list for the frontend MCPManager
  if (url === "/api/v1/tools") {
